    ...
    public class InitialMigration : Migration
    {
        public override void Up()
        {
            ...
            Create.Table("user_words")
                .WithColumn("id").AsGuid().PrimaryKey().Unique().NotNullable()
                .WithColumn("word").AsCustom("varchar(256)").Unique().NotNullable()
                .WithColumn("translated").AsCustom("varchar(256)").Unique().Nullable()
            ...
            Create.ForeignKey("FK_Words_UserWords_UserWordTypeId")
                .FromTable("user_word_types").ForeignColumn("word_type_id")
                .ToTable("word_types").PrimaryColumn("id")
                .OnDeleteOrUpdate(System.Data.Rule.Cascade);

            Create.ForeignKey("FK_Words_UserWordTypes_UserWordsId")
                .FromTable("user_word_types").ForeignColumn("user_word_id")
                .ToTable("user_words").PrimaryColumn("id")
                .OnDeleteOrUpdate(System.Data.Rule.Cascade);
