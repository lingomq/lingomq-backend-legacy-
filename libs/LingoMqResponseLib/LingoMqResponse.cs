using LingoMqResponseLib.StatusCodes;
using Microsoft.AspNetCore.Mvc;

namespace LingoMqResponseLib;
/// <summary>
...
public class LingoMqResponse
{
    ...
    public static IActionResult OkResult<T>(T data, string message = "Success") =>
        ResponseResult.SuccessResult((int)SuccessCode.Success, message, data);
    ...
    public static IActionResult AcceptedResult<T>(T data, string message = "Accepted") =>
        ResponseResult.SuccessResult((int)SuccessCode.Accepted, message, data);
    ...
    public static IActionResult AcceptedResult(string message = "Accepted") =>
        ResponseResult.SuccessResult((int)SuccessCode.Accepted, message);
    ...
    public static IActionResult NoContentResult<T>(T data, string message = "No Content") =>
        ResponseResult.SuccessResult((int)SuccessCode.NoContent, message, data);
    ...
    public static IActionResult BadRequestResult<T>(T error, string message = "An error occurred") =>
        ResponseResult.ClientErrorResult((int)ClientErrorCode.BadRequest, message, error);
    ...
    public static IActionResult ForbiddenResult<T>(T error, string message = "Forbidden") =>
        ResponseResult.ClientErrorResult((int)ClientErrorCode.Forbidden, message, error);
    ...
    public static IActionResult NotFoundResult(string message = "Object not found. See error for additional info") =>
        ResponseResult.ClientErrorResult((int)ClientErrorCode.NotFound, message);
    ...
    public static IActionResult UnauthorizedResult<T>(T error, string message = "Unauthorized") =>
        ResponseResult.ClientErrorResult((int)ClientErrorCode.NotFound, message, error);
    ...
    public static IActionResult RequestTimeoutResult() =>
        ResponseResult.ClientErrorResult((int)ClientErrorCode.Timeout, "Request timeout. Check your connection");
    ...
    public static IActionResult ConflictResult<T>(T error, string message = "Conflict") =>
        ResponseResult.ClientErrorResult((int)ClientErrorCode.Conflict, message, error);
